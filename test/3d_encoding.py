...
import argparse
'''
run this: python .\3d_encoding_2.py -al gaussian -an True -af p_norm, euclidean, euclidean
'''
...
for i in range(n_test):
    ...
    C = Clustering(data_concat, args.algorithm, args.affinity, n_clusters, thres = None, p = -2)
